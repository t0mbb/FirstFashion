                    ...
                    <div class="container">
                        <div class="w3l-space-banner">
                            <div class="carousel-caption-banner" style="max-width: 100%; height: 500px">
                                <img class="d-block w-100 img-fluid" src="{{asset('image/banner1.jpg')}}"
                                     alt="First slide">
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item item4">
                <div class="banner-style d-flex align-items-center">
                    <div class="container">
                        <div class="w3l-space-banner">
                            <div class="carousel-caption-banner" style="max-width: 100%; height: 500px">
                                <img class="d-block w-100" src="{{asset('image/banner4.jpg')}}" alt="Fourth slide">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="banner-style d-flex align-items-center">
                        <div class="container">
                            <div class="w3l-space-banner">
                                ...
                                <img  src="{{asset('image/binhgold.jpg')}}" class="d-block w-100 img-fluid" alt="First slide">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item item2">
                    <div class="banner-style d-flex align-items-center">
                        <div class="container">
                            <div class="w3l-space-banner">
                                <div class="carousel-caption-banner" style="max-width: 100%; height: 500px">
                                    <img src="{{asset('image/banner5.jpg')}}" class="d-block w-100" alt="Second slide">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item item3">
                    <div class="banner-style d-flex align-items-center">
                        <div class="container">
                            <div class="w3l-space-banner">
                                <div class="carousel-caption-banner" style="max-width: 100%; height: 500px">
                                    <img src="{{asset('image/banner6.jpg')}}" class="d-block w-100" alt="Third slide">
                                </div>
                            </div>
                        </div>
                    </div>
