                        ...
                        <div class="col-lg-9 mx-auto">
                            ...
                            <ul class="list-group shadow"style="padding-bottom: 20px;">
                                ...
                                <li class="list-group-item"style="background: linear-gradient(to right, #c04848, #480048);color : whitesmoke;">
                                    <!-- Custom content-->
                                    <a href="{{route('FirstFashion.detailShirt', ['shirt_id' => $s->shirt_id])}}" style="color: whitesmoke;">
                                    <div  class="media align-items-lg-center flex-column flex-lg-row p-3">
                                        <div class="media-body order-2 order-lg-1" >
                                            <h5 style="font-size: 23px;" class="mt-0 font-weight-bold mb-2">{{$s->shirt_name}}</h5>
                                            <p style="color: #29ccee;"  class="font mb-0 large">{{$s->shirt_description}}</p>
                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                <h6 style="font-size: 23px;" class="font-weight-bold my-2">{{ $s->shirt_price }}$</h6>
