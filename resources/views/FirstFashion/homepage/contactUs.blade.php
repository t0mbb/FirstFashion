            ...
            <div class="container mt-5" >
                ...
                <div class="row" style="height:450px;">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{route('FirstFashion.MailContact', ['contact' => $contact])}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text"  name="name" class="form-control mt-2" placeholder="Name" required value="{{$contact->name}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="email"  name="email"class="form-control mt-2" placeholder="email" required value="{{$contact->email}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="phone" class="form-control mt-2" placeholder="Phone number" required value="{{$contact->phone}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <input class="form-control mt-2" list="datalistOptions"
                                           placeholder="Gender" name="gender"value="{{$contact->gender}}">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" name="message" placeholder="Your Message" rows="3" value="{{$contact->message}}"></textarea>
                                    </div>
                                </div>
