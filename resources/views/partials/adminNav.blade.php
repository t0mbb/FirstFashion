...
<section id="container">
    ...
    <header class="header fixed-top clearfix">
        <!--logo start-->
        <div class="brand">
            <a href="{{route('FirstFashion.index')}}" class="logo" style="font-size: 25px ">
                <b>First Fashion</b>
            </a>
        </div>
<style>
        ...
        <div id="sidebar" class="nav-collapse">
            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    <li>
                        <a class="active" href="{{route('FirstFashion.index')}}" style="font-size: 25px">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{route('FirstFashion.admin_manager')}}" style="font-size: 20px">Admin Manager</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" style="font-size: 25px">
                        ...
                        <ul class="sub">
                            <li><a href="{{route('FirstFashion.customer_manager')}}" style="font-size: 20px">Customer Manager</a></li>
{{--                            <li><a href="responsive_table.html">Responsive Table</a></li>--}}
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{route('FirstFashion.category_manager')}}" style="font-size: 20px">Category Manager</a></li>
                            <li><a href="{{route('FirstFashion.createCategory')}}" style="font-size: 20px">New Category</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" style="font-size: 25px">
