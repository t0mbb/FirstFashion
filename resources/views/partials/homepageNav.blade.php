                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 search-wrapper">
                        ...
                        <div class="input-holder">
                            <form action="{{route('FirstFashion.search')}}" method="GET">
                            ...
                            <input type="text" class="search-input" name="search" placeholder="Type name of shirts" value="{{old('search')}}">
...
{{--                                               href="#">T-shirt</a>--}}
                    ...
                    <li class="nav-item mr-lg-2 mb-lg-0 mb-2">
                        <a style="font-size: 20px" class="nav-link" role="button"
                           href="{{route('FirstFashion.gallery')}}"
                        ><b>Gallery</b></a>
                    </li>
                    <li class="nav-item">
                        <a style="font-size: 20px" class="nav-link"
