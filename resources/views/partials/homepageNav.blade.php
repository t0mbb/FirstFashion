            ...
            <div class="col-lg-3 col-md-4 logo_agile">
                <h1>
                    <a href="{{route('FirstFashion.homepage')}}" style="font-family:'Javanese Text'">
                        <img src="{{asset('image/logo.jpg')}}" style="width: 100px; height: 70px" alt="">
                        First Fashion</a>
                </h1>
            </div>
            <!-- //logo -->
                        ...
                        <div class="col-lg-8 col-sm-7 header-right ml-auto text-sm-right text-center">
                            ...
                            <ul class="top-header-lists">
                                <li style="list-style: none">
                                    <a href="{{route('FirstFashion.registerCustomer')}}" style="font-size: 20px; color: blue">
...
{{--                                                <li>--}}
{{--                                                    <a class="dropdown-item" href="{{route('A1uniform.UniformbyCat', ['cat_id' => $cat->cat_id])}}">{{$cat->cat_name}}</a>--}}
...
{{--                           href="{{route('A1uniform.aboutUs')}}"--}}
                        ><b>About Us</b></a>
                    </li>

                    <li class="nav-item mr-lg-2 mb-lg-0 mb-2">
                        <a style="font-size: 20px" class="nav-link"
{{--                           href="{{route('A1uniform.allUniform')}}"--}}
                        ><b>All Products</b></a>
                    </li>
                    <li class="nav-item">
                        <a style="font-size: 20px" class="nav-link"
{{--                           href="{{route('A1uniform.contactUs')}}"--}}
                        ><b>Contact Us</b></a>
                    </li>

                    <li  class="nav-item mr-lg-2 mb-lg-0 mb-2">
                        <a style="font-size: 20px" class="nav-link"
{{--                           href="{{route('A1uniform.feedback')}}"--}}
                        ><b>Feedback</b></a>
                    </li>
                </ul>
            </div>
