...
<div class="form-group" style="margin-left: 100px">
    <label style="color: deepskyblue; font-size: 30px" for="shirt_name" class="font-weight-bold">Name</label>
...
<div class="mb-3" style="margin-left: 100px">
    <label  style="color: deepskyblue; font-size: 30px" for="shirt_image" class="font-weight-bold">Images</label>
    <img class="img-fluid" alt="Shirt Image" width="230" height="120" src="<?php echo e(asset('storage/images/shirt/'.$shirt->shirt_image )); ?>" alt="">
    <input class="form-control" type="file" id="shirt_image" name="shirt_image" value="<?php echo e(old('shirt_image')?? $shirt->shirt_image); ?>">
</div>

<div class="form-group" style="margin-left: 100px">
    <label  style="color: deepskyblue; font-size: 30px; margin-top: 10px" for="shirt_material"
...
<div class="form-group" style="margin-left: 100px">
<label  style="color: deepskyblue; font-size: 30px" for="shirt_size" class="font-weight-bold">Size</label>
...
<div class="form-group" style="margin-left: 100px">
    <label  style="color: deepskyblue; font-size: 30px" for="shirt_price" class="font-weight-bold">Price</label>
    <input type="text" class="form-control" id="shirt_price" name="shirt_price"
           value="<?php echo e(old('shirt_price')?? $shirt->shirt_price); ?>">
</div>

<div class="form-group" style="margin-left: 100px">
    <label  style="color: deepskyblue; font-size: 30px" for="cat_id" class="font-weight-bold">Category</label>
...
<div class="form-group" style="margin-left: 100px">
    <label style="color: deepskyblue; font-size: 30px" for="shirt_description" class="font-weight-bold">Description</label>
...
<?php /**PATH /Users/t0mbb./Documents/asm/FirstFashion/resources/views/FirstFashion/shirt/shirtFields.blade.php ENDPATH**/ ?>