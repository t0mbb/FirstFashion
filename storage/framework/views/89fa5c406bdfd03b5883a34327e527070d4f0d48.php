<?php $__env->startSection('main'); ?>
    <div class="container">
        ...
        padding-bottom: 10px;
        margin-bottom: 50px;
        font-family: 'Century';"  class="display-4"><b>Add New Category</b></h1>
        </div>
...
<?php echo $__env->make('masters.adminMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/t0mbb./Documents/c03/FirstFashion/resources/views/FirstFashion/category/newCategory.blade.php ENDPATH**/ ?>